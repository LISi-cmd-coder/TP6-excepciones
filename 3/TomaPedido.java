...
public class TomaPedido {
    public static void main(String[] args) {
        ...
        try {
            // Crear el pedido con una lista vacía
            ...
            // Intenta quitar todos los productos (simulación de eliminación)
            pedido.getProductos().clear();

            // Aserción para verificar que el pedido tenga al menos un producto
            assert !pedido.getProductos().isEmpty() : "El pedido debe contener al menos 1 producto";
